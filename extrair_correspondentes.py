...
df_cabecalho = pd.read_excel(
    r"C:\Users\gusta\OneDrive\Desktop\Projeto Python\Automacoes\Automacao_leads\Project_Bets\202403CORRESPONDENTES.xlsx",
    engine="openpyxl",
    nrows=1
)

# Exibir os nomes exatos das colunas
print("Colunas detectadas no Excel:", df_cabecalho.columns.tolist())
...
df_colunas_utilizadas.to_excel("teste_v5.xlsx", index=False, engine="openpyxl")

# 📌 1️⃣3️⃣ Mensagem que aparece quando o Excel é salvo corretamente
print("Arquivo 'teste_v5.xlsx' Deu bom! Foguete não da RÉ kkkkkk🚀")
